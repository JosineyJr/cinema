...
/**
 * The ProductDTO class represents the data transfer object for product
 * information.
...
public class ProductDTO {
  ...
  /**
   * Constructs a new ProductDTO object with the specified ID, name, price,
  ...
  /**
   * Constructs a new ProductDTO object with the specified name, price,
   * quantity, and inventory ID.
   * 
   * @param name        The name of the product.
   * @param price       The price of the product.
