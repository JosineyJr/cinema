 ...
 */
public class UpdateProductInfosController extends Controller<EditProductInfosDTO> {
  private UpdateProductInfosUseCase updateProductUseCase;
  private UpdateInventoryUseCase updateInventoryUseCase;

  public UpdateProductInfosController(UpdateProductInfosUseCase updateProductUseCase,
   ...
   *
   * @param object The EditProductInfosDTO object containing the updated product
   *               information.
  ...
  /**
   * Builds and returns a list of validators for the given EditProductInfosDTO
   * object.
   *
   * @param object The EditProductInfosDTO object containing the product
