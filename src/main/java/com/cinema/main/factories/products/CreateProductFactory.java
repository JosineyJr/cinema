...
public class CreateProductFactory {
  public static Controller<CreateProductDTO> make() {
    ...
    CreateProductUseCase createProductUseCase = new CreateProductUseCase(pgProductRepository, pgInventoryRepository, pgProductRepository);

    CreateInventoryUseCase createInventoryUseCase = new CreateInventoryUseCase(pgInventoryRepository);

    CreateProductController createProductController = new CreateProductController(createProductUseCase, createInventoryUseCase);
