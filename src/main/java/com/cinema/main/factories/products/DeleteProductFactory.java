...
public class DeleteProductFactory{
  public static Controller<DeleteProductDTO> make() {
    ...
    DeleteInventoryUseCase deleteInventoryUseCase = new DeleteInventoryUseCase(inventoryRepository, inventoryRepository);

    DeleteProductController deleteProductController = new DeleteProductController(deleteProductUseCase, deleteInventoryUseCase);
