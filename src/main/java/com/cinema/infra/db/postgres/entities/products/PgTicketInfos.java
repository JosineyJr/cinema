...
@Entity(name = "ticket_infos")
public class PgTicketInfos {
  @Id
  @GeneratedValue
  private UUID ID;
  ...
  public PgTicketInfos() {
  }

  public PgTicketInfos(UUID ID, double price, PgMovieSession movieSession) {
    this.ID = ID;
    this.price = price;
    this.movieSession = movieSession;
  }

  public PgTicketInfos(double price, PgMovieSession movieSession) {
    this.price = price;
    this.movieSession = movieSession;
  }
